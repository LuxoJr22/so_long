...
/*   Updated: 2023/02/08 21:39:00 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	relinput(int keycode, t_game *game)
{
	...
	if (keycode == 122 && game->player->diry == -1)
	{
		//printf("oui\n");
		game->player->diry = 0;
	}
	//if (keycode == 0 && game->player->dirx == -1)
	if (keycode == 113 && game->player->dirx == -1)
		game->player->dirx = 0;
	//if (keycode == 1 && game->player->diry == 1)
	if (keycode == 115 && game->player->diry == 1)
		game->player->diry = 0;
	//if (keycode == 2 && game->player->dirx == 1)
	if (keycode == 100 && game->player->dirx == 1)
		game->player->dirx = 0;
	//if (keycode == 126 && game->tears->dir == 1)
	if (keycode == 65362 && game->tears->dir == 1)
		game->tears->dir = 0;
	//if (keycode == 124 && game->tears->dir == 2)
	if (keycode == 65363 && game->tears->dir == 2)
		game->tears->dir = 0;
	//if (keycode == 125 && game->tears->dir == 3)
	if (keycode == 65364 && game->tears->dir == 3)
		game->tears->dir = 0;
	//if (keycode == 123 && game->tears->dir == 4)
	if (keycode == 65361 && game->tears->dir == 4)
		game->tears->dir = 0;
	return (0);
}
